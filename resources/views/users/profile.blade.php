            ...
            <div class="card-body">
                <div class="text-center">
                    <div class="userprofile">
                        <div class="userpic  brround"> <img src="{{ asset('assets/images/users/female/7.jpg') }}" alt="" class="userpicimg"> </div>
                        <h3 class="username text-dark mb-2">Sonia Rees</h3>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex mb-3">
                    <img alt="User Avatar" class="rounded-circle avatar-lg mr-2" src="{{ asset('assets/images/users/female/7.jpg') }}">
        ...
        <div class="card panel-theme">
            ...
            <div class="card-body no-padding">
                <ul class="list-group no-margin">
                    ...
                    <li class="list-group-item"><i class="fa fa-globe mr-4"></i> www.Dashmint.com</li>
                ...
                <div class="memberblock mb-0">
                    <div class="row ">
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4 pl-1 pr-1 m-t-5 m-b-5">
                            <a href="" class="member"><img src="{{ asset('assets/images/users/male/3.jpg') }}" alt="">
                                <div class="memmbername">Ajay Sriram</div>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4 pl-1 pr-1 m-t-5 m-b-5">
                            <a href="" class="member"><img src="{{ asset('assets/images/users/female/8.jpg') }}" alt="">
                                <div class="memmbername">Samantha</div>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 pl-1 pr-1 m-t-5 m-b-5">
                            <a href="" class="member"><img src="{{ asset('assets/images/users/female/4.jpg') }}" alt="">
                                <div class="memmbername">Stella</div>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 pl-1 pr-1 m-t-5 m-b-5">
                            <a href="" class="member"><img src="{{ asset('assets/images/users/male/2.jpg') }}" alt="">
                                <div class="memmbername">James Thomas</div>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 pl-1 pr-1 m-t-5 m-b-5">
                            <a href="" class="member"><img src="{{ asset('assets/images/users/male/8.jpg') }}" alt="">
                                <div class="memmbername">Christopher</div>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 pl-1 pr-1 m-t-5 m-b-5">
                            <a href="" class="member"><img src="{{ asset('assets/images/users/male/5.jpg') }}" alt="">
