( function ( $ ) {
	...
	gradientStroke.addColorStop(0, '#765be6');
	gradientStroke.addColorStop(1, '#765be6');
    var myChart = new Chart( myCanvas, {
		type: 'line',
		data: {
	...
	gradientStroke1.addColorStop(0, '#e44374');
	gradientStroke1.addColorStop(1, '#e44374');
